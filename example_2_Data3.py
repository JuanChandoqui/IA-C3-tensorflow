...
if __name__ == "__main__":
    ...
    file='dataset03.txt'
    datay = np.loadtxt(file, delimiter=',', dtype=np.float32,  skiprows=1, usecols=[1])
    print(datay)
    print(datay[1])
    ...
    #model.add(tf.keras.layers.Dense(1, input_dim=1, activation='exponential', kernel_initializer='glorot_uniform', bias_initializer='zeros'))
